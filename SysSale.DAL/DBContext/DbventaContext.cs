...
using SysSale.Entity;

namespace SysSale.DAL.DBContext;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=(local); Initial Catalog=DBVENTA; User Id=brian593; Password=Cyb3rCl0n; Encrypt=false; Command Timeout=9000");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Categoria>(entity =>
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C85C7BA2D");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F83102192");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483C98126B4");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107239BCA00");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547ECA277D22");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A1324D1FC58A");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F760BD9B275");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D82E7CFD32");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE81F9F4B1");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A67234AAB7");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D56148ECC612B");
